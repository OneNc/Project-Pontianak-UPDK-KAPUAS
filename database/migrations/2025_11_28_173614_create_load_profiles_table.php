...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('load_profiles', function (Blueprint $table) {
            ...
            $table->float('export_wh_total')->nullable();
            $table->float('import_wh_total')->nullable();
            $table->float('export_varh_total')->nullable();
            $table->float('import_varh_total')->nullable();
            ...
            $table->float('avg_power_factor_total')->nullable();
            $table->float('avg_frequency')->nullable();
